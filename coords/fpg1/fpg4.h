...
extern void print_fpg_pars_deriv(FILE *fpo, int idoder);
extern void delta_for_deriv(double dxy_mm, int npixccd);
extern void read_fpg_stars(FILE *fpin, FILE *fpd, double pxbor);
extern void print_fpg_star(int i, FILE *fpo);
extern void print_fpg_all_stars(FILE *fpo);
extern void fill_mrq_stars();

extern double ra_sc, dec_sc, roll_sc, radecroll[3];
extern double dtor;
