 ...
 * Heritage: aml2na1.c
 *
 * perform various computations related to deriving NASA-Ames geometric parameters
 * from AML's geometric parameters.
 *
 ...
 *
 * June 13, 2018: Test other conventions for camera focal plane x,y coordinates.
 */
...
double cpxlo[NCCD], cpxhi[NCCD], cpylo[NCCD], cpyhi[NCCD];
